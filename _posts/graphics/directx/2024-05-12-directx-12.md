...
FD3D12RootSignatureDesc::FD3D12RootSignatureDesc(const FD3D12QuantizedBoundShaderState& QBSS, const D3D12_RESOURCE_BINDING_TIER ResourceBindingTier)
{
	...
	case D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE:
	{
		...
		{
			// Constant Buffer View로 활용할 것이며, Shader.ShaderResourceCount 만큼 활용할 것이며, 0u 번지부터 활용할 것이다
...
- 텍스쳐가 Constant Buffer와 다른점은? Constant Buffer와 달리 Desc.Heap에 View를 딱 하나만 만들어도 된다 ( 16 : 16 )
- ( 20 : 00 )
