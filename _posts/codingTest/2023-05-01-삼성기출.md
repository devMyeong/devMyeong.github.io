...
void performRoll(int row, int col, int size)
{
	...
	{
		int tmp = copiedGrid[row - d][col - d];

		// Left side
		for (int i = row - d + 1; i <= row + d; i++)
			copiedGrid[i - 1][col - d] = copiedGrid[i][col - d];

		// Bottom side
		for (int i = col - d + 1; i <= col + d; i++)
			copiedGrid[row + d][i - 1] = copiedGrid[row + d][i];
