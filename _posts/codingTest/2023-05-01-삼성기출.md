...
void CleanDust()
{
	...
	for (int i = R - 1; cr + 1 <= i; i--) board[i][C - 1] = board[i - 1][C - 1];
	for (int j = C - 1; 2 <= j; j--) board[cr][j] = board[cr][j - 1];
	board[cr][1] = 0;
}
