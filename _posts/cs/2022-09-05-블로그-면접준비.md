...
- 언리얼 컴포넌트별 특징을 설명하면? UActorComponent는 기본 컴포넌트 USceneComponent는 변환(위치, 회전, 스케일) 정보를 가진 컴포넌트 UPrimitiveComponent는 렌더링 또는 충돌 기능을 가진 컴포넌트 ([**참고**](https://andongmin.com/docs/unrealCpp/ch4/ch4-2))
