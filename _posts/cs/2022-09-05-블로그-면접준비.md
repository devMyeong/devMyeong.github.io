...
- 게임 모드와 게임 스테이트에 대해 설명하면? 게임모드는 게임에 필요한 규칙을 정의하는 클래스이고 게임 스테이트는 클라이언트가 게임의 상태를 모니터링할 수 있도록 도와주는 클래스이다 ([**참고**](https://docs.unrealengine.com/4.26/ko/InteractiveExperiences/Framework/GameMode/))
